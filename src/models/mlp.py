...
TODO: https://github.com/aidiary/keras-examples/blob/master/mlp/cifar10.py
"""
...
def build_simple_mlp(input_shape=(3, 32, 32), dropout=0.0, l2=0., training=None, n_filters=32, activation="relu",
