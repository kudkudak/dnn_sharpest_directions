...
m=0
l2=0
commonparams="--dataset=cifar --which=100 --reload --optim=nsgd --n_epochs=${n_epochs} --reduce_callback --early_stopping  --reduce_callback_kwargs=\"{'monitor': 'val_loss', 'patience':$patience}\" --early_stopping_patience=$espatience --m=${m} --lr_schedule=\"\""
