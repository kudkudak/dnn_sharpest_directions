...
commonparams="--dataset=cifar --which=100 --reload --optim=nsgd --n_epochs=${n_epochs} --reduce_callback --early_stopping --early_stopping_patience=$espatience --m=${m} --lr_schedule=\"\""
