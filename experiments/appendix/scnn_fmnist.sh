...
commonparams="--reload --augmentation --optim=nsgd --n_epochs=${n_epochs} --reduce_callback --early_stopping --early_stopping_patience=$espatience --m=${m} --lr_schedule=\"\""
...
# Run no mom, no L2
id=0
for config in medium_fmnist; do
for seed in 777; do
